            ...
            Connections {
                ...
                onArduinoRead: {
                    ...
                    if (temp.cut == false) {
                        ...
                        else if (ardReply == "95480" && temp.step_stamp == 3) {con.send("x62.8")}
                    ...
                    //Cutting
                        ...
                        else if (ardReply == "95480" && temp.step_cut == 3) {con.send("x60")}
                        ...
                        else if (ardReply == "95480" && temp.step_cut == 6) {con.send("raiseCutter")}
                        ...
                        else if (ardReply == "95480" && temp.step_cut == 8) {con.send("x490")}
                        ...
                        //After Cutting, Raise Cutter
                        else if (ardReply == "95480" && temp.step_cut == 11) {con.send("raiseCutter")}
